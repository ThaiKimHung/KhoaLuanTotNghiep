...
namespace Data_API_MXH.Controllers.KhoaLuan
{
    ...
    public class CommentDetailController : ApiController
    {

        [Route("getDSComentViewDetail")]
        [HttpGet]


        public object getDSComentViewDetail(int id_user, int id_cmt)
        {
            ...
            try
            {
                ...
                // code dung 
                sql = @"
                select bd.ID_BAIDANG,ID_LOAIBAIDANG,TIEUDE,ID_COMMENT,NOIDUNG_BAIDANG,bd.TYPEPOST,CreatedDate,CreatedBy,UpdateDate,UpdateBy,ID_KHENTHUONG,ID_GROUP from TBL_BAIDANG as bd ,TBL_COMMENT as cmt
   where bd.ID_BAIDANG=cmt.ID_BAIDANG
                ORDER BY bd.ID_BAIDANG DESC
";
...
");
                ...
                return Json(new
                {
                    ...
                    data = from r in dt.AsEnumerable()
                           where r["ID_COMMENT"].Equals(id_cmt)
                           select new
                           {
