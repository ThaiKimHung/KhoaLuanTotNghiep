...
export default class Edit_ChaoMungTV_Detail_Nhom extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      DsKhenThuong: [],
  ...
  ganData = async () => {
    ...
    this.setState({
      ...
      group: id_nguoidang ? id_nguoidang[0].Group[0] : '',
        ...
        <View style={styles.header}>
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            <View
              ...
              <Text style={styles.title}>Sửa bài đăng CMTVM CT Nhóm</Text>
            </View>
            <TouchableOpacity
