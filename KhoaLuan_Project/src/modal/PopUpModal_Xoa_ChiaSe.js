...
export default class PopUpModal_Xoa_ChiaSe extends Component {
  constructor(props) {
    super(props);
    this.state = {
      display: true,
  ...
  XoaBaiDangChiaSe = async () => {
    let res = await deleteBaiDangChiaSe(this.state.idBaiDang);
    if (res.status == 1) {
      showMessage({
        message: 'Thông báo',
        description: 'Xóa bài chia sẻ thành công',
        type: 'success',
        duration: 1500,
        icon: 'success',
      });
      ...
      showMessage({
        message: 'Thông báo',
        description: 'Xóa bài chia sẻ thất bại',
        type: 'danger',
        duration: 1500,
        icon: 'danger',
      });
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Alert.alert(
                      'Thông Báo',
                      'Bạn Muốn Xóa Bài Đăng Chia Sẻ?',
                      [
                        {
                          text: 'Đồng ý',
                          onPress: () => this.XoaBaiDangChiaSe(),
                        },
                        {
                          text: 'Hủy',
                          style: 'cancel',
                ...
                >
                  <Image source={delet} style={styles.image_st}></Image>
                  <Text style={{fontSize: 20}}>Xóa chia sẻ</Text>
                </TouchableOpacity>
              </View>
            </TouchableWithoutFeedback>
          </TouchableOpacity>
