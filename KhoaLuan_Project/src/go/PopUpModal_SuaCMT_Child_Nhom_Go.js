...
export default class PopUpModal_SuaCMT_Child_Nhom_Go extends Component {
  constructor(props) {
    super(props);
    this.state = {
      display: true,
  ...
  change = async () => {
    ...
    await Utils.goscreen(this, 'ScreenCMT_Child_Nhom_Go');
  ...
  Sua_Cmt = async () => {
    ...
    // console.log('strBody cmt child nohm', strBody);
